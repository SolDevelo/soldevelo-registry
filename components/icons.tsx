  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke="currentColor"
        strokeWidth="1.1"
        d="M12 5.5c5.24 0 9.5 2.91 9.5 6.5s-4.26 6.5-9.5 6.5S2.5 15.59 2.5 12 6.76 5.5 12 5.5Z"
      />
      <path
        fill="none"
        stroke="currentColor"
        strokeWidth="1.1"
        d="M8.07 8.25c2.62-4.54 6.5-7.24 9.6-5.45s3.02 6.66.4 11.2-6.5 7.24-9.6 5.45-3.02-6.66-.4-11.2Z"
      />
      <path
        fill="none"
        stroke="currentColor"
        strokeWidth="1.1"
        d="M15.93 8.25c2.62 4.54 2.7 9.41-.4 11.2s-6.98-.91-9.6-5.45-2.7-9.41.4-11.2 6.98.91 9.6 5.45Z"
      />
    </svg>
  )
}
...
// Stands in for words inside a line of copy, so it has to be part of the first
// paint; next/image lazy-loads by default and would leave a hole mid-sentence.
